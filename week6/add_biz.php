...
if (isset($_POST['name'])) {
    ...
    foreach ($category as $cat) {
        $query_biz = "INSERT INTO Biz_Categories (BusinessID, CategoryID) VALUES ('$id','$cat')";
        mysqli_query($connect, $query_biz);
    }
    if ($results_id) {
        print "update oke";
...
<body>
    ...
    <div id='newForm' style="display:<?php if (isset($_POST['name'])) echo 'none' ?>;">
    ...
    <div id='result' style="display:<?php if (!isset($_POST['name'])) echo 'none' ?>;">
